...
class Bill_App:
    def __init__(self, master):
        ...
        title=Label(self.master,text="SHOP MANAGEMENT SYSTEM",bd=12,relief=GROOVE,bg="orange red",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        ...
        # ------------>>> CUSTOMER DETAILS <<<<<-----------------
        F0=LabelFrame(self.master,bd=10,relief=GROOVE,text="Customer Details",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F0.place(x=0,y=70,width=950)
        
        cname_label=Label(F0,text="Customer Name",bg="blue",font=("times new romen",18,"bold")).grid(row=0,column=0,padx=20,pady=5)
        cname_txt=Entry(F0,width=20,textvariable=self.c_name,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=1,pady=5,padx=10)
        
        cphn_label=Label(F0,text="Phone No.",bg="blue",font=("times new romen",18,"bold")).grid(row=0,column=2,padx=20,pady=5)
        cphn_txt=Entry(F0,width=20,textvariable=self.c_phon,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=3,pady=5,padx=10)
        
         ################################ send email button
        F1=LabelFrame(self.master,bd=10,relief=GROOVE,text="send bill via Email ",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F1.place(x=950,y=70,width=587)
        
        cmail_label=Label(F1,text="Email",bg="blue",font=("times new romen",18,"bold")).grid(row=0,column=4,padx=20,pady=5)
        ...
        #----------------->>>>> COsmetic frame <<<----------------
        F2=LabelFrame(self.master,bd=10,relief=GROOVE,text="Cosmetic",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        ...
        bath_label=Label(F2,text="Bath Soap",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        #face cream
        facecream_label=Label(F2,text="Face Cream",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        #Facewash
        facewash_label=Label(F2,text="Facewash",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        #hair spray
        hair_Spry_label=Label(F2,text="Hair Spray",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        #Hair gel
        hair_gel_label=Label(F2,text="Hair Gel",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        #bodylotion
        body_lt_label=Label(F2,text="Body Lotion",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        #bath_shampoo_label=Label(F2,text="Bath Shampoo",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=6,column=0,padx=10,pady=10,sticky="w")
        #bath_shampoo_txt=Entry(F2,width=10,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=6,column=1,padx=10,pady=10)
        
        #bath_shampoo_label=Label(F2,text="hair oil",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=7,column=0,padx=10,pady=10,sticky="w")
        #bath_shampoo_txt=Entry(F2,width=10,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=7,column=1,padx=10,pady=10)
        
         #----------------->>>>> Groccery frame <<<----------------
        F3=LabelFrame(self.master,bd=10,relief=GROOVE,text="Grocery",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F3.place(x=276,y=152,width=220,height=393)
        
        g1_label=Label(F3,text="Maggi",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        g2_label=Label(F3,text="Rice",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        g3_label=Label(F3,text="Wheat",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        g4_label=Label(F3,text="Food oil",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        g5_label=Label(F3,text="Daal",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        g6_label=Label(F3,text="Sugar",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        g6_txt=Entry(F3,width=4,textvariable=self.sugar,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10,sticky=W)
         ...
         #----------------->>>>> cold-drink frame <<<----------------
        F4=LabelFrame(self.master,bd=10,relief=GROOVE,text="Cold Drink",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F4.place(x=490,y=152,width=220,height=393)
        
        c1_label=Label(F4,text="Maza",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        c2_label=Label(F4,text="Coca cola",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        c3_label=Label(F4,text="Fanta",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        c4_label=Label(F4,text="Slice",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        c5_label=Label(F4,text="Red Bull",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        c6_label=Label(F4,text="Pepsi",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        #----------------->>>>> Biscuit frame <<<----------------
        F4=LabelFrame(self.master,bd=10,relief=GROOVE,text="Biscuits",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F4.place(x=705,y=152,width=230,height=393)
        
        c1_label=Label(F4,text="Bourbon",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=0,column=0,padx=10,pady=10,sticky="w")
        ...
        c2_label=Label(F4,text="Britania",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        ...
        c3_label=Label(F4,text="Oreo",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=2,column=0,padx=10,pady=10,sticky="w")
        ...
        c4_label=Label(F4,text="Good Day",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=3,column=0,padx=10,pady=10,sticky="w")
        ...
        c5_label=Label(F4,text="Sunfist",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=4,column=0,padx=10,pady=10,sticky="w")
        ...
        c6_label=Label(F4,text="Monaco",font=("times new roman",16,"bold"),fg="white",bg="blue").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        ...
        F7=LabelFrame(self.master,bd=10,relief=GROOVE,text="Bill Menu",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F7.place(x=0,y=540,relwidth=1,height=180)
        
        m1=Label(F7,text="Total Cosmetic Price",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=0,column=0,padx=20,pady=1,sticky=W)
        ...
        m2=Label(F7,text="Total Grocery Price",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=1,column=0,padx=20,pady=1,sticky=W)
        ...
        m3=Label(F7,text="Total Cold-drink Price",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky=W)
        ...
        m4=Label(F7,text="Total Biscuit Price",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=3,column=0,padx=20,pady=1,sticky=W)
        ...
        tax1=Label(F7,text="Cosmetic Tax (28%)",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=0,column=2,padx=20,pady=1,sticky=W)
        ...
        tax2=Label(F7,text="Grocery Tax (5%)",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=1,column=2,padx=20,pady=1,sticky=W)
        ...
        tax3=Label(F7,text="Cold-drink Tax (40%)",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=2,column=2,padx=20,pady=1,sticky=W)
        ...
        tax4=Label(F7,text="Biscuit Tax (5%)",bg="blue",fg="white",font=("times new roman",14,"bold")).grid(row=3,column=2,padx=20,pady=1,sticky=W)
        ...
        self.welcome_bill()
        #----------------->>>>> bill search frame <<<----------------
        F8=LabelFrame(self.master,bd=10,relief=GROOVE,text="Bill Search ",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        ...
        search_btn=Button(F8,text="Search",command=self.find_bill,bg="cyan",bd=5,fg="black",width=8,font="arial 12 bold").grid(row=0,column=2)
           ...
           #---------------Admin area-----------------------
        F9=LabelFrame(self.master,bd=10,relief=GROOVE,text="Admin area ",font=("times new roman",15,"bold"),fg="gold",bg="blue")
        F9.place(x=351,y=712,width=1186,height=80)
            
        
        
        Label(F9,text="Login :  | ",font=("times new roman",15,"bold"),fg="white",bg="blue").grid(row=0,column=0)
        Label(F9,text="ID ",font=("times new roman",15,"bold"),fg="white",bg="blue").grid(row=0,column=1)
        ...
        Label(F9,text="  Password",font=("times new roman",15,"bold"),fg="white",bg="blue").grid(row=0,column=3)
        ...
        #-------sign up----------------
        Label(F9,text="  Create New Account",font=("times new roman",15,"bold"),fg="white",bg="blue").grid(row=0,column=6)
    ...
    def image_section(self):
        ...
        F5=LabelFrame(self.master,bd=10,relief=GROOVE,bg="blue")
...
class login_page_window:
    def __init__(self, master1):
        ...
        F1=LabelFrame(self.master1,bd=10,relief=GROOVE,text="MENU",font=("times new roman",15,"bold"),fg="white",bg="blue")
        F1.place(x=0,y=133,width=230,height=600)
        
        today_sell=Button(F1,text="Today's Sell",bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=0,column=0,padx=10,pady=15)
        
        total_sell=Button(F1,text="Total Sell",bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=1,column=0,padx=10,pady=15)
        
        stock=Button(F1,text="Stock",command=self.check_stock,bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=2,column=0,padx=10,pady=15)
        
        update_stock=Button(F1,text="Update Stock",command=self.Update_stock,bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=3,column=0,padx=10,pady=15)
        
        change_password=Button(F1,text="Change password",bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=4,column=0,padx=10,pady=15)
        
        lis_of_bill=Button(F1,text="Bill List",command=self.bill_list,bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=5,column=0,padx=10,pady=15)
        
        clear=Button(F1,text="Clear",command=self.clear_admin_notebook,bg="cyan",bd=5,fg="white",width=15,font="arial 12 bold").grid(row=6,column=0,padx=10,pady=15)
        
        
        
        F3=LabelFrame(self.master1,bd=10,text="Bottom",relief=GROOVE,bg="blue")
        ...
        F2=LabelFrame(self.master1,bd=10,relief=GROOVE,bg="blue")
        ...
        #F2=LabelFrame(self.master1,bd=10,text="image",relief=GROOVE,bg="blue")
        #F2.place(x=230,y=133,width=550,height=600)
